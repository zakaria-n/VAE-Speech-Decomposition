...
def extract_formants(sound, gender):
    ...
    '''
    time_step = 0  # time between the centres of consecutive analysis frames
    ...
    if gender == 'male':
        ...
        f0min = 75
        f0max = 600
        # An average adult female speaker has a vocal tract length that requires an average ceiling of 5500 Hz
    ...
    formants = praat.call(sound, "To Formant (burg)", time_step,
                          max_nb_formants, formant_ceiling, window_length, pre_emphasis)
